    ...
    <form id="addWithDropZoneForm" type="post" action="<?php echo $adminBaseUrl . '/' . $controllerName . '/save'; ?>" novalidate="novalidate">
        <div class="card-body">
            <div class="form-group">
                ...
                <input name="name" id="name" placeholder="Banner name" type="text" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="url_mask" class="">Url</label>
                <input name="url_mask" id="url_mask" placeholder="Url" type="url" class="form-control" required>
            </div>
            <div class="form-group">
